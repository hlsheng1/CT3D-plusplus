...
class DataBaseSampler(object):
    ...
    def add_sampled_boxes_to_scene(self, data_dict, sampled_gt_boxes, total_valid_sampled_dict, mv_height=None, sampled_gt_boxes2d=None):
        ...
        pre_box_mask = np.ones([gt_boxes.shape[0], 1])
        extra_box_mask = np.zeros([sampled_gt_boxes.shape[0], 1])
        gt_box_aug_mask = np.concatenate([pre_box_mask, extra_box_mask], axis = 0)
        data_dict['gt_box_aug_mask'] = gt_box_aug_mask
        ...
        # print(sampled_gt_boxes.shape[0])
        # print(data_dict['add_box_mask'].shape[0])
    ...
    def __call__(self, data_dict):
        ...
        data_dict['gt_box_aug_mask'] = np.zeros([gt_boxes.shape[0], 1])
