...
def rotate_points_along_z_return_calib(points, angle):
    """
    Args:
        points: (B, N, 3 + C)
    ...
    rot_matrix = rot_matrix.view(3,3)
    return points_rot.numpy()[0] if is_numpy else points_rot[0], rot_matrix.numpy() if is_numpy else rot_matrix
