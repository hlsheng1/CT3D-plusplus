...
from pcdet.models.img_backbone.DCNv2.dcn_v2 import DCN
...
class DLABackbone(nn.Module):
    ...
    def __init__(self, model_cfg, **kwargs):
        ...
        base_name = model_cfg.CONV_BODY
        pretrained = model_cfg.PRETRAIN
    ...
    def forward(self, data_dict):
        ...
        # torch.Size([8, 3, 384, 1280])
        x = data_dict['images'].permute(0,3,1,2).contiguous()
        x = self.base(x)
        ...
        data_dict['img_dla_feature'] = y[-1] # shape: torch.Size([2, 64, 96, 320])
